 ...
 * on 2016-05-30 at 00:52:11 UTC 
 * Modify at your own risk.
 */

package com.example.mealbuddy.myapplication.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MessagingEndpoint {
    ...
    /**
     * Create a request for the method "messagingEndpoint.sendMessage2Match".
     *
     * This request holds the parameters needed by the messaging server.  After setting any optional
     * parameters, call the {@link SendMessage2Match#execute()} method to invoke the remote operation.
     *
     * @param message
     * @param regid1
     * @param regid2
     * @return the request
     */
    public SendMessage2Match sendMessage2Match(java.lang.String message, java.lang.String regid1, java.lang.String regid2) throws java.io.IOException {
      SendMessage2Match result = new SendMessage2Match(message, regid1, regid2);
      initialize(result);
      return result;
    }

    public class SendMessage2Match extends MessagingRequest<Void> {

      private static final String REST_PATH = "sendMessage2Match/{message}/{regid1}/{regid2}";

      /**
       * Create a request for the method "messagingEndpoint.sendMessage2Match".
       *
       * This request holds the parameters needed by the the messaging server.  After setting any
       * optional parameters, call the {@link SendMessage2Match#execute()} method to invoke the remote
       * operation. <p> {@link SendMessage2Match#initialize(com.google.api.client.googleapis.services.Ab
       ...
       * @since 1.13
       */
      protected SendMessage2Match(java.lang.String message, java.lang.String regid1, java.lang.String regid2) {
        super(Messaging.this, "POST", REST_PATH, null, Void.class);
        this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
        this.regid1 = com.google.api.client.util.Preconditions.checkNotNull(regid1, "Required parameter regid1 must be specified.");
        this.regid2 = com.google.api.client.util.Preconditions.checkNotNull(regid2, "Required parameter regid2 must be specified.");
      }

      @Override
      public SendMessage2Match setAlt(java.lang.String alt) {
        return (SendMessage2Match) super.setAlt(alt);
      }

      @Override
      public SendMessage2Match setFields(java.lang.String fields) {
        return (SendMessage2Match) super.setFields(fields);
      }

      @Override
      public SendMessage2Match setKey(java.lang.String key) {
        return (SendMessage2Match) super.setKey(key);
      }

      @Override
      public SendMessage2Match setOauthToken(java.lang.String oauthToken) {
        return (SendMessage2Match) super.setOauthToken(oauthToken);
      }

      @Override
      public SendMessage2Match setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendMessage2Match) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendMessage2Match setQuotaUser(java.lang.String quotaUser) {
        return (SendMessage2Match) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendMessage2Match setUserIp(java.lang.String userIp) {
        return (SendMessage2Match) super.setUserIp(userIp);
      }
      ...
      public SendMessage2Match setMessage(java.lang.String message) {
        this.message = message;
        return this;
      }

      @com.google.api.client.util.Key
      private java.lang.String regid1;

      /**

       */
      public java.lang.String getRegid1() {
        return regid1;
      }

      public SendMessage2Match setRegid1(java.lang.String regid1) {
        this.regid1 = regid1;
        return this;
      }

      @com.google.api.client.util.Key
      private java.lang.String regid2;

      /**

       */
      public java.lang.String getRegid2() {
        return regid2;
      }

      public SendMessage2Match setRegid2(java.lang.String regid2) {
        this.regid2 = regid2;
        return this;
      }

      @Override
      public SendMessage2Match set(String parameterName, Object value) {
        return (SendMessage2Match) super.set(parameterName, value);
      }
    }
